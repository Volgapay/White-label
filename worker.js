...
async function handleRequest(request) {
  ...
  const targetUrl = 'https://api.volgapay.com';
  ...
  // Example https://api.yourdomain.com/set-affiliate.php?address=0xF977814e90dA44bFA03b6295A0616a897441aceC&callback=https%3A%2F%2Fwww.example.com%2Forder%3Fnumber%3D82173314628191&merchant_fee=0.91&sub_affiliate_fee=0.01&sub_affiliate=0x082489A616aB4D46d1947eE3F912e080815b08DA
  ...
  url.search += (url.search ? '&' : '') + 'affiliate_fee=0.01'; //Total custom fees should always be 0.92 so if you set yours 1% (0.01) per the example then you instruct your sub-affiliate for 0.91 total in your API docs.
...
// Example https://api.yourdomain.com/vcc-set-affiliate.php?provider=mastercard&amount=5&sub_affiliate_fee=0.03&sub_affiliate=0x082489A616aB4D46d1947eE3F912e080815b08DA
  ...
  // Set custom fees total should always be 0.92 (The commission set here should work for both credit cards and crypto systems for your direct merchants)
  url.search += (url.search ? '&' : '') + 'affiliate_fee=0.01';
  url.search += (url.search ? '&' : '') + 'merchant_fee=0.91';
	  }
  }	  
